<template>
    ...
    <div class="flex justify-center items-center text-center">
      <h2 class="text-4xl max-sm:text-3xl w-[44%] max-lg:w-[80%] max-sm:w-[100%] max-sm:px-1  font-[500] font-squada">LinksUs is a Data Driven Platform to <span class="text-blue2">enhance talent
  ...
  <div class="frame laptop-frame">
    <img
      ...
      class="frame-img"
    />
    <img src="https://res.cloudinary.com/dyghenjwh/image/upload/v1722571831/laptop1-resize_a6p8w5.jpg" alt="Laptop Image" class="content-img laptop-img rounded-lg" />
  </div>
  ...
  <div class="frame mobile-frame">
    <img
      ...
      class="frame-img"
    />
    <img src="https://res.cloudinary.com/dyghenjwh/image/upload/v1722310086/LinksUs/mobile1_e6mdh2.jpg" alt="Mobile Image" class="content-img mobile-content-img rounded-3xl" />
  </div>
</div>
...
<div class="mt-32">
  ...
  <div class="flex justify-center items-center">
    <ul class="list-none p-0 m-0 flex flex-wrap justify-center gap-4 w-full max-w-4xl sm:max-w-3xl max-sm:flex-col xs:max-w-xl">
...
<div class="mt-32">
    <div class="flex flex-col justify-center items-center">
      <h2 class="lg:text-5xl md:text-4xl text-3xl font-squada mb-4 text-center max-md:px-2">Additional Services for Companies</h2>
  ...
  <div class="mt-10">
    <div class="flex justify-center items-center">
      <ul class="list-none p-0 m-0 flex flex-wrap justify-center gap-4 w-full max-w-4xl sm:max-w-3xl xs:max-w-xl max-sm:flex-col">
        <li class="flex flex-col bg-white border border-gray-300 shadow-lg rounded-3xl p-4 sm:p-8 min-h-[160px] flex-grow w-[calc(50%-0.5rem)] max-sm:w-full hover:bg-whiteo">
          <span class="mb-2 flex justify-center items-center">
...
.mobile-content-img {
  top: 3%; /* Adjust based on your frame's structure */
